# 1 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/dbcsr_example_add.F"
!--------------------------------------------------------------------------------------------------!
...
PROGRAM dbcsr_example_3
   USE dbcsr_api,                       ONLY: &
        dbcsr_add, dbcsr_copy, dbcsr_create, dbcsr_distribution_get, dbcsr_distribution_new, dbcsr_distribution_release, &
...
!$ USE OMP_LIB, ONLY: omp_get_max_threads, omp_get_thread_num, omp_get_num_threads
   ...
   CALL dbcsr_add(matrix_a, matrix_b, 0.0_real_8, 1.0_real_8)
