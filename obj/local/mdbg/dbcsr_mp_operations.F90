# 1 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/dist/dbcsr_mp_operations.F"
!--------------------------------------------------------------------------------------------------!
...
! **************************************************************************************************
   SUBROUTINE dbcsr_sendrecv_any(msgin, dest, msgout, source, comm)
      ...
      IF (dbcsr_data_get_type(msgin) .NE. dbcsr_data_get_type(msgout)) &
         CPABORT("Different data type for msgin and msgout")
...
! **************************************************************************************************
   SUBROUTINE dbcsr_rget_any(base, source, win, win_data, myproc, disp, request, &
      ...
      IF (dbcsr_data_get_type(base) /= dbcsr_data_get_type(win_data)) &
         CPABORT("Mismatch data type between buffer and window")
...
! **************************************************************************************************
!> \brief Bcast function of encapsulated data.
!> \param base ...
!> \param source ...
!> \param grp ...
!> \param request ...
...
! **************************************************************************************************
!> \brief Scatter function of encapsulated data.
!> \param base ...
!> \param counts ...
!> \param displs ...
!> \param msg ...
...
! **************************************************************************************************
!> \brief Gather function of encapsulated data.
!> \param base ...
!> \param ub_base ...
!> \param msg ...
!> \param counts ...
...
! **************************************************************************************************
!> \brief Send/Recv function of encapsulated data.
!> \param msgin ...
!> \param dest ...
!> \param msgout ...
!> \param source ...
...
# 1 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/dist/dbcsr_mp_operations.f90" 1
!--------------------------------------------------------------------------------------------------!
!   CP2K: A general program to perform molecular dynamics simulations                              !
!   Copyright (C) 2000 - 2018  CP2K developers group                                               !
!--------------------------------------------------------------------------------------------------!

# 1 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/dist/../data/dbcsr.fypp" 1
# 8 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/dist/../data/dbcsr.fypp"
# 39 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/dist/../data/dbcsr.fypp"
# 7 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/dist/dbcsr_mp_operations.f90" 2
# 8 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/dist/dbcsr_mp_operations.f90"
! **************************************************************************************************
!> \brief Row/column and global all-to-all
!> \param sb ...
!> \param scount ...
...
# 252 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/dist/dbcsr_mp_operations.f90"
# 773 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/dist/dbcsr_mp_operations.F" 2
