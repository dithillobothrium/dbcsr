# 1 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/dbcsr_test_add.F"
!--------------------------------------------------------------------------------------------------!
...
! **************************************************************************************************
   SUBROUTINE dbcsr_test_adds(test_name, mp_group, mp_env, npdims, io_unit, &
      ...
      CHARACTER, DIMENSION(2, 5), PARAMETER :: symmetries = RESHAPE((/dbcsr_type_no_symmetry, &
         dbcsr_type_no_symmetry, dbcsr_type_symmetric, dbcsr_type_symmetric, &
         dbcsr_type_antisymmetric, dbcsr_type_antisymmetric, dbcsr_type_hermitian, &
         dbcsr_type_hermitian, dbcsr_type_antihermitian, dbcsr_type_antihermitian/), (/2, 5/))
...
! **************************************************************************************************
   SUBROUTINE dbcsr_check_add(test_name, matrix_a, dense_a_dbcsr, dense_a, dense_b, &
      ...
      IF (.NOT. valid) &
         CPABORT("dense matrix not valid")
      !
      !
      ...
      CASE (dbcsr_type_complex_4_2d)
         ...
         DEALLOCATE (work_sp)
      CASE default
         CPABORT("Incorrect or 1-D data type")
      END SELECT
