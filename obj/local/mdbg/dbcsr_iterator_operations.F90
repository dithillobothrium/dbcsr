# 1 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/block/dbcsr_iterator_operations.F"
!--------------------------------------------------------------------------------------------------!
...
!$       CPWARN("Thread distribution should be defined for OpenMP.")
      IF (.NOT. iterator%dynamic .AND. .NOT. dbcsr_distribution_has_threads(dist)) &
         CPABORT("Thread distribution must be defined for non-dynamic iterator.")
!$    IF (omp_in_parallel() .AND. omp_get_num_threads() /= dbcsr_distribution_num_threads(dist)) &
!$       CPABORT("Number of threads has changed!")
...
!$OMP        BARRIER
      ...
      !   CPABORT("Locally-indexed matrices can only have a dynamic iterator.")
...
# 1 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/block/dbcsr_iterator_operations.f90" 1
!--------------------------------------------------------------------------------------------------!
!   CP2K: A general program to perform molecular dynamics simulations                              !
!   Copyright (C) 2000 - 2018  CP2K developers group                                               !
!--------------------------------------------------------------------------------------------------!
...
# 7 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/block/dbcsr_iterator_operations.f90" 2
# 8 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/block/dbcsr_iterator_operations.f90"
! **************************************************************************************************
...
# 141 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/block/dbcsr_iterator_operations.f90"
# 767 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/block/dbcsr_iterator_operations.F" 2
