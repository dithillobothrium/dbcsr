# 1 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/block/dbcsr_block_operations.F"
!--------------------------------------------------------------------------------------------------!
...
# 1 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/block/dbcsr_block_operations.f90" 1
!--------------------------------------------------------------------------------------------------!
!   CP2K: A general program to perform molecular dynamics simulations                              !
!   Copyright (C) 2000 - 2018  CP2K developers group                                               !
!--------------------------------------------------------------------------------------------------!
...
# 7 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/block/dbcsr_block_operations.f90" 2
# 8 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/block/dbcsr_block_operations.f90"
! **************************************************************************************************
!> \brief Copies a block subset
!> \param dst ...
!> \param dst_rs ...
...
# 543 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/block/dbcsr_block_operations.f90"
# 1527 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/block/dbcsr_block_operations.F" 2
