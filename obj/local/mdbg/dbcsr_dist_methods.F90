# 1 "/data/isivkov/libdbcsr_svn18247/src/dbcsr/dist/dbcsr_dist_methods.F"
!--------------------------------------------------------------------------------------------------!
...
!$       CPABORT("Thread number has changed")
